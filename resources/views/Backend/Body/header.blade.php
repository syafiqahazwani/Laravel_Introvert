                    ...
                    <div class="navbar-brand">
                        ...
                        <a href="index.html">
                            ...
                            <span class="logo-text">
                                <!-- dark Logo text -->
                                <img src="{{asset('Backend')}}/assets/images/logo.png" alt="homepage" class="dark-logo" width="132" height="52"/>
                                <!-- Light Logo text -->
                                <img src="{{asset('Backend')}}/assets/images/logo.png" class="light-logo" alt="homepage" width="132" height="52"/>
                            </span>
                        </a>
                    </div>
                    <!-- End Logo -->
    ...
    <div class="dropdown-menu dropdown-menu-left mailbox animated bounceInDown">
        <ul class="list-style-none">
            ...
            <li>
                <a class="nav-link pt-3 text-center text-dark" href="{{ route('admin.dashboard') }}">
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown"
                        ...
                        <img src="{{ (!empty($adminData->photo)) ? url('Images/Admin_Profile/'.$adminData->photo) : url('Images/admin.png') }}" alt="user" class="rounded-circle"
                            width="40">
                        <span class="ml-2 d-none d-lg-inline-block"><span>Hello,</span> <span
                                class="text-dark">{{ $adminData->username }}</span> <i data-feather="chevron-down"
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <a class="dropdown-item" href="{{ route('admin.profile') }}"><i data-feather="user"
                            ...
                            My Profile</a>
                        <a class="dropdown-item" href="{{ route('admin.register') }}"><i data-feather="mail"
                                class="svg-icon mr-2 ml-1"></i>
                            User Register Box</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="{{ route('admin.change.password') }}"><i data-feather="settings"
                                class="svg-icon mr-2 ml-1"></i>
                            Change Password</a>
                        <div class="dropdown-divider"></div>
